...
class CourseStructureTestMixin(object):
    ...
    def assertValidCourseStructure(self, course_key, modulestore):
        ...
        for key, value in expected.blocks.iteritems():
            print actual.blocks[key].__dict__
            print value.__dict__
            self.assertEqual(actual.blocks[key], value)
        self.maxDiff = None
        self.assertDictEqual(actual.blocks, expected.blocks)
